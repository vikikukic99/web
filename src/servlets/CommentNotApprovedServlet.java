...
public class CommentNotApprovedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommentNotApprovedServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		comment.setCommentStatus(CommentStatus.Not_approved);
		WebContext.getInstance().save();
		
		
		//da li moze da se refresuje odma da se ne vraca na homePage
